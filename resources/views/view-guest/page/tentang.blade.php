    ...
    <div class="section-layout-home">
        ...
        <section id="quotes">
            <div class="container text-center ">
                ...
                <div class="mb-4 pb-1 ">
                    <p>"In logistics, the difficulty is not in achieving perfection, but in consistently delivering
                        excellence." - Katie Zobrist </p>
                    <p>"Efficiency in logistics is not just about moving goods, but about moving value." - John Seely Brown
                    </p>
                    <p>"The key to successful campus logistics is synchronization - aligning the right resources at the
                        right time." - Ben Van Heuvelen</p>
                    <p>"Logistics excellence on campus is a blend of precision, focus, and adaptability." - Adam Moore</p>
                    <p>"Strategic campus logistics management is the art of turning complexity into simplicity." - Chris
                        Cooper</p>
                </div>
            </div>
            <div class="pb-4">
                <a href="/pinjam" class="btn merah mt-4 mb-4 card-hover">Pinjam Barang</a>
            </div>
        </section>
    </div>
@endsection
